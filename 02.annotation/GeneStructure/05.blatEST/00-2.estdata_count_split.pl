...
#	    print O "$last_query_name\t$scaffold_name\t$hash{$last_query_name}{$scaffold}\t\n";
	}
	%hash_tmp = (); 
    }
...
# foreach my $query_name(sort keys %hash){
#     foreach my $scaffold (sort keys %{$hash{$query_name}}){
#	print O "$query_name\t$scaffold\t$hash{$query_name}{$scaffold}\t$query{$query_name}\n";
#     }
# }
#print O "$last_query_name\t$scaffold_name\t$hash{$last_query_name}{$scaffold_name}\t\n";
#foreach my $query_name(keys %total_blast){
#    print O "$query_name\t$total_blast{$query_name}\t$query{$query_name}\n";
#}
